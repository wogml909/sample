...
public class MultiCatch2 {
	...
	public static void main(String[] args) {
		...
		//멀티 catch
		// : 하나의 catch 블록에서 처리하고 싶은 예외를 |기호로 연결하여 함께 처리한다.
		// 상위 예외 클래스가 하위 예외 클래스보다 아래쪽에 위치해야 한다.
		catch (ArrayIndexOutOfBoundsException |NumberFormatException e) {//자리수 오류 메세지
			System.err.println("접근할 수 없는 배열 index 범위입니다 (한 자리수 입력한 경우)");
		    System.out.println("숫자로 변환할 수 없는 값입니다(문자를 입력한 경우)");
		} 
		catch (Exception e) {//최상위 오류메세지 
