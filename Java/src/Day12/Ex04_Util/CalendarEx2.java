...
public class CalendarEx2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1시간 후 : " + after1Day);

		// 이번 주 로또 추첨일시?
		// * 매일 오전 6시~24시까지 판매
		// 추첨일(토요일)에는 오후 8시에 판매 마감
		// 추첨일 오후부터 다음일(일요일) 오전 6시까지 판매 정지
...
//		lottoCal.set(Calendar.HOUR, 1);
		...
		String todayOfWeek = ""; // 오늘 요일

		// 조건
		// 일요일 6시~토요일8시 :이번 주 토요일 오후 9시
		switch (요일) {
        ...
        if(buyYn) {
        	...
        	System.err.println("구매 가능한 시간에 다시오세요");
        }
		
		// 토
		// 1. 8시 이후 : 구입불가 또는 다음 주 토요일 오후 9시
		// 2. 8시 이전 : 이번 주 토요일 오후 9시
		// 일 : 구입불가 또는 다음 주 토요일 오후 9시

//		cal.add(cal.WEEK_OF_MONTH, 1);
//		String after1Week = sdf.format(cal.getTime());
