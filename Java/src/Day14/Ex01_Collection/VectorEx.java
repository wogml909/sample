...
public class VectorEx {
	...
	public static void main(String[] args) {
	    ...
	    //반복 방법 2
	    // * foreach 문
	    System.out.println(">>반복2 - foreach문");
	    ...
	    System.out.println(">>반복3 - iteraotor 활용한 반복");
		...
		System.out.println();
						     ...
						     //삭제
						     //-삭제할 때, 삭제한 위치 뒤에 index가 앞으로 한 칸 씩 당겨진다
						     //   0     1        2      3        4
