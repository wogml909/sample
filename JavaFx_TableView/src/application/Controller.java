...
//테이블뷰, 리스트뷰 등의 데이터 초기화할때, Initializable 인터페이스 구현
public class Controller implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		// new PropertyValueFactory("getter이름:)  : 값으로 들어갈 객체의 게터 이름을 지정하는 객체
		// **게터이름 : getXXX. get을 제외한 게터 메소드 이름
		// ex) getNo() --->No
		// ※ modyle-info.java --> java.base모듈 추가해야 사용가능
